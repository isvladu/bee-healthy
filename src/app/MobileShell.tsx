...
/**
 * The original single-column shell, unchanged. It still owns every viewport
 * below `lg` until Workstream 5 redesigns it; the Nectar desktop shell takes
 * over above that (EXPANSION_PLAN §7.1).
 */
  ...
  return (
    <div className="mx-auto flex min-h-full max-w-md flex-col">
      <header className="sticky top-0 z-10 flex items-center gap-2 border-b border-honey-100 bg-honey-50/80 px-4 py-3 backdrop-blur">
        ...
        <h1 className="text-lg font-bold tracking-tight text-honey-800">Bee Healthy</h1>
      </header>
